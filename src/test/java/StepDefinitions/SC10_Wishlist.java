...
//        }
        ...
        {   login = new LoginPage(Hooks.driver);
            ...
            Thread.sleep(2000);
            Hooks.driver.findElement(By.xpath("//button[@onclick='return AjaxCart.addproducttocart_catalog(\"/addproducttocart/catalog/37/2/1\"),!1']")).click(); //add to cart
            Hooks.driver.findElement(By.xpath("//button[@onclick='return AjaxCart.addproducttocart_catalog(\"/addproducttocart/catalog/38/2/1\"),!1']")).click(); //add to cart
        ...
        public void ExpectedResult() throws InterruptedException {
            ...
            Thread.sleep(2000);
            Assert.assertTrue(Hooks.driver.findElement(By.className("remove-from-cart")).isDisplayed());
