...
//    }
    ...
    public void fill_Form() throws InterruptedException {
        newUser = new RegistrationPage(Hooks.driver);
        ...
        Hooks.driver.findElement(By.id("FirstName")).sendKeys("Tom");
        Hooks.driver.findElement(By.id("LastName")).sendKeys("Smith");
        Select drpDate = new Select(Hooks.driver.findElement(By.name("DateOfBirthDay")));
        drpDate.selectByVisibleText("10");
        drpDate = new Select(Hooks.driver.findElement(By.name("DateOfBirthMonth")));
        drpDate.selectByVisibleText("January");
        drpDate= new Select(Hooks.driver.findElement(By.name("DateOfBirthYear")));
